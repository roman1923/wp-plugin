<?php
/**
 * developex functions and definitions
 *
...
function developex_setup() {
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'developex_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'developex_setup' );
 ...
 */
function developex_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'developex_content_width', 640 );
}
add_action( 'after_setup_theme', 'developex_content_width', 0 );
